...
class MSBuffer(object):
	...
	for i in self.Listerased:
	    ...
	    # AQUI TIREI UM TAB, CONFERIR SE FUNCIONOU!!
	...
	self.pattern = "_variable_interest_inside_donut_buffer_" # Pattern to be found in the map names
	...
	for i in self.listclip:
		...
		arcpy.DeleteField_management(i, ["Area_ha"]) # Delete this column
	...
	for i in self.listclip:
		...
		arcpy.CalculateField_management(i,"Area_ha","!shape.area@hectares!","PYTHON_9.3","#")
    ...
    def calculateAreaInsideBufferffer(self):
	'''
...
# Run instance
run_instance = Run(inputmap, inputmap_name, inputCol, variable_interest, OutPutTxt, OutPutFolder,
                   scale, nbuffers, count_on_off, func_area_on_off)
# Run
fun.run()
